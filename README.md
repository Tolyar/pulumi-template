...
1. Run the following command to update files to use the name of your provider (third-party: use your GitHub organization/username):
   ...
   - find and replace all instances of the boilerplate `template` with the `NAME` of your provider.
...
before:
  ...
  - make tfgen
builds:
- binary: pulumi-resource-template
  dir: provider
  goarch:
  - amd64
  - arm64
  ...
  ignore: []
  ldflags:
  - -X github.com/Tolyar/pulumi-template/provider/pkg/version.Version={{.Tag}}
  main: ./cmd/pulumi-resource-template/
  sort: asc
  use: git
release:
  disable: false
...
├── config.yaml
├── metadata.json
├── pulumi-template_darwin_amd64_v1
│   └── pulumi-resource-template
├── pulumi-template_darwin_arm64
│   └── pulumi-resource-template
├── pulumi-template_linux_amd64_v1
│   └── pulumi-resource-template
├── pulumi-template_linux_arm64
│   └── pulumi-resource-template
├── pulumi-template_windows_amd64_v1
│   └── pulumi-resource-template.exe
└── pulumi-template_windows_arm64
    └── pulumi-resource-template.exe
```
